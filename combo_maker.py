...
def main():
	with open(hash_pass, "r", encoding="utf8") as r:
		for line_old in r:
			...
			with open(string_hash, "rt", encoding="utf8") as string_hash_reader:
				for string_hash_reader_line in string_hash_reader:
					if hash_from_file in string_hash_reader_line:
						...
						with open("temp.txt", "a", encoding="utf8") as result_file_new:
							result_file_new.write(replaced_line)
	print(" [+] Done! Removing empty lines...")
	with open("temp.txt", encoding="utf8") as infile, open("results.txt", 'w', encoding="utf8") as outfile:
		for line in infile:
